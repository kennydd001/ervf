#!/usr/bin/env python3
"""No-forward CPU preflight for immutable PORT80B T0-R4-REF-R5."""
...
LOCK=R/"port80b_t0r4r5_runner_lock.json"; VLOCK=R/"port80b_t0r4r5_verifier_lock.json"
OUT=R/"port80b_t0r4r5_ref_cpu_preflight.json"; REF=ROOT/".venv-next-ref/Scripts/python.exe"
...
def main():
 ...
 ck("verifier_lock",sha(VERIFIER)==vlock["verifier_sha256"] and vlock["schema_version"]=="PORT80B_T0R4R5_REF_V1")
 ...
 vrequired=["expected_schema()","manual_ulp_recomputed","prefix_bytes_recomputed","cache_recomputed","routes_recomputed","quantize_source(source_value)","fields.max()<=30","raw_manifest_recomputed","dependencies_rehashed","runtime_actual","clean_replay_independent","failure_adjudication"]

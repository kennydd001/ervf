#!/usr/bin/env python3
"""Independent PH1 NVIDIA N4 compile/physical verifier.
...
LOCK = REPORTS / "het_next_l0_ph1_nvidia_n4_verifier_lock.json"; COMPILE = REPORTS / "het_next_l0_ph1_nvidia_n4_compile"; PHYSICAL = REPORTS / "het_next_l0_ph1_nvidia_n4_physical"; OUT = REPORTS / "het_next_l0_ph1_nvidia_n4_independent_verification.json"
SOURCE_LOCK = REPORTS / "het_next_l0_ph1_nvidia_n4_source_lock.json"; CUDA_SOURCE = SCRIPTS / "het_next_l0_ph1_nvidia_n4_kernels.cu"
CUDA_SHA = "49ba8c1e6d20a96fd4b20014c7071698226d6d3f3aca3bed11da7b03b13283c4"
CPU = REPORTS / "het_next_l0_ph1_cpu_freeze_r2"; SHARD = Path(r"C:/Users/de_do/.cache/huggingface/hub/models--Qwen--Qwen4-Coder-Next/snapshots/a19358a7659bd1f564300250ee189120c49a562f/model-00001-of-00040.safetensors"); D2 = ROOT / "reports/runs/streamq5_moe/port80b_t0r12d2r3_cloned_serialization/t0r12d2_raw.safetensors"
...
def provenance():
 try:
  ...
  if lock.get("kind")!="het_next_l0_ph1_nvidia_n4_verifier_lock":return False
...
def verify_compile(directory, provenance_fn=provenance):
 kind="het_next_l0_ph1_nvidia_n4_compile";directory=Path(directory);checks={"provenance":provenance_fn(),"bundle":bundle(directory,kind)}
 try:
  ...
  "candidate_source":sha(source)==CUDA_SHA==fsha(CUDA_SOURCE) and bound=={"path":"scripts/streamq5_moe/het_next_l0_ph1_nvidia_n4_kernels.cu","sha256":CUDA_SHA} and r["artifact_manifest"]["source.cu"]["sha256"]==CUDA_SHA and r["authorization"]["observed"]["cuda_source"]==CUDA_SHA,
...
def verify_physical(directory, provenance_fn=provenance, prepare_fn=prepare):
 kind="het_next_l0_ph1_nvidia_n4_physical";directory=Path(directory);checks={"provenance":provenance_fn(),"bundle":bundle(directory,kind)}
 try:

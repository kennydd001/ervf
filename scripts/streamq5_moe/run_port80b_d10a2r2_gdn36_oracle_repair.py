...
COMPILE_OUT = R / "port80b_d10a2r2_gdn36_oracle_repair_preflight.json"
COMPILE_REPORT = R / "PORT80B_D10A2R2_GDN36_ORACLE_REPAIR_PREFLIGHT_REPORT_2026-08-13.md"
COMPONENT_OUT = R / "port80b_d10a2r2_gdn36_oracle_repair.json"
ENDURANCE_OUT = R / "port80b_d10a2r2_gdn36_oracle_repair_endurance_10k.json"
...
def audit() -> tuple[dict[str, Any], dict[str, np.ndarray], dict[str, str]]:
    ...
    checks = {
        ...
        "conv_oracle_cpu_unit_locked_and_passed": (
            ...
            and conv_unit["inputs"]["runner_sha256"] == sha256(Path(__file__))
            and conv_unit["inputs"]["preregistration_sha256"] == sha256(PREREG)
            and conv_unit["inputs"]["unit_test_sha256"] == sha256(CONV_UNIT_TEST)
...
def compile_phase() -> None:
    ...
    result = {
        "kind": "port80b_d10a2r2_gdn36_oracle_repair_cpu_preflight",
    ...
    COMPILE_REPORT.write_text(
        ...
        "and did not scan the bank. The executable D10A2-R2 component gate is implemented; "
...
def endurance_phase(acknowledgement: str | None) -> None:
    locked_compile()
    raise RuntimeError(
        "D10A2-R2 endurance is unconditionally fail-closed; a new post-component preregistration and runner are required"
    )

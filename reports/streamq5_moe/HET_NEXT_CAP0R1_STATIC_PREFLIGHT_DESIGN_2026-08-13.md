# HET-NEXT-CAP0-R1 â€” static preflight design

This is a standalone capability-only design. Static preflight imports standard library only and makes zero device/runtime calls. It opens no D2, shard, checkpoint or model artifact because none belongs to CAP0-R1.
...
Static PASS cannot authorize capability. An authorization-only lock revision and independent audit are required before one physical CAP0-R1 attempt.

#!/usr/bin/env python3
"""Independent PH1 NVIDIA N3 compile/physical verifier.
...
LOCK = REPORTS / "het_next_l0_ph1_nvidia_n3_verifier_lock.json"; COMPILE = REPORTS / "het_next_l0_ph1_nvidia_n3_compile"; PHYSICAL = REPORTS / "het_next_l0_ph1_nvidia_n3_physical"; OUT = REPORTS / "het_next_l0_ph1_nvidia_n3_independent_verification.json"
SOURCE_LOCK = REPORTS / "het_next_l0_ph1_nvidia_n3_source_lock.json"; CUDA_SOURCE = SCRIPTS / "het_next_l0_ph1_nvidia_n3_kernels.cu"
CUDA_SHA = "1070f0f216bc65e87c3e1ee7dabd20498c2b08e0bfabad07e48ed6dfd3be2fb8"
...
def provenance():
 try:
  ...
  if lock.get("kind")!="het_next_l0_ph1_nvidia_n3_verifier_lock":return False
...
def verify_compile(directory):
 kind="het_next_l0_ph1_nvidia_n3_compile";directory=Path(directory);checks={"provenance":provenance(),"bundle":bundle(directory,kind)}
 try:
  ...
  "candidate_source":sha(source)==CUDA_SHA==fsha(CUDA_SOURCE) and bound=={"path":"scripts/streamq5_moe/het_next_l0_ph1_nvidia_n3_kernels.cu","sha256":CUDA_SHA} and r["artifact_manifest"]["source.cu"]["sha256"]==CUDA_SHA and r["authorization"]["observed"]["cuda_source"]==CUDA_SHA,
...
def verify_physical(directory):
 kind="het_next_l0_ph1_nvidia_n3_physical";directory=Path(directory);checks={"provenance":provenance(),"bundle":bundle(directory,kind)}
 try:

#!/usr/bin/env python3
"""S0-C1-R2 self-bound CPU/no-forward preflight; TEMP lifecycle only."""
import ast,hashlib,json,os,tempfile
from pathlib import Path
ROOT=Path(__file__).resolve().parents[2];S=ROOT/'scripts/streamq5_moe';R=ROOT/'reports/streamq5_moe';SELF=Path(__file__);RUN=S/'run_port80b_t0q5s0c1r2_control_only.py';VER=S/'verify_port80b_t0q5s0c1r2_control_only.py';PR=R/'PORT80B_T0Q5S0C1R2_CONTROL_ONLY_PREREGISTRATION_2026-08-13.md';LOCK=R/'port80b_t0q5s0c1r2_runner_lock.json';VL=R/'port80b_t0q5s0c1r2_verifier_lock.json';PL=R/'port80b_t0q5s0c1r2_preflight_lock.json';D=ROOT/'reports/runs/streamq5_moe/port80b_t0q5s0c1r2_control_only'
...
def simulation():
 with tempfile.TemporaryDirectory(prefix='s0c1r2_') as z:

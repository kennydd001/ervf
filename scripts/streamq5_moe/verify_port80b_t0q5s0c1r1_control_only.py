#!/usr/bin/env python3
"""Independent S0-C1-R1 verifier; directly rereads official source and reconstructs the sentinel."""
...
def verify():
 ...
 checks['claim_status']=r['kind']=='port80b_t0q5s0c1r1_control_only' and r['status']=='control_sensitivity_positive' and 'synthetic control sensitivity only' in r['claim_boundary'] and 'R5 remains formal verifier-negative' in r['claim_boundary']
 ...
 return {'kind':'t0q5s0c1r1_independent_verification','pass':all(checks.values()),'checks':checks}
def main():

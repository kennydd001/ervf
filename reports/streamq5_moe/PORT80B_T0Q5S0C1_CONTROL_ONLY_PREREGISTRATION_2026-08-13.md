...
Expected extra resources: one real shared-down source tensor plus decoded and mutated copies, under 64 MiB working RAM; retained evidence under 1 MiB; no GPU; no model construction; no persistent Q5 bank; no network/download.

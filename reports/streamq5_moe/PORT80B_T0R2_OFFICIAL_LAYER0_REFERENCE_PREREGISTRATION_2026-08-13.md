# PORT80B-T0-R2 — immutable official layer-0 reference preregistration
...
This is the immutable codec correction after the blocked T0-R and T0-R1
documents. Both older documents remain evidence. R2 retains R1 provenance,
inputs, thresholds, model scope and claim boundary. Its sole semantic repair is
to name the already-proven STREAMQ5 wire mapping correctly: biased `q+15`, not
two's complement. No T0 result existed when this correction was frozen.
...
Any failure closes T0-P2. No post-output retuning is permitted.

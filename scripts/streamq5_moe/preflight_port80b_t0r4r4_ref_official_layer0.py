#!/usr/bin/env python3
"""No-forward CPU preflight for immutable PORT80B T0-R4-REF-R4."""
...
LOCK=R/"port80b_t0r4r4_runner_lock.json"; VLOCK=R/"port80b_t0r4r4_verifier_lock.json"
OUT=R/"port80b_t0r4r4_ref_cpu_preflight.json"; REF=ROOT/".venv-next-ref/Scripts/python.exe"
...
def main():
 ...
 ck("verifier_lock",sha(VERIFIER)==vlock["verifier_sha256"] and vlock["schema_version"]=="PORT80B_T0R4R4_REF_V1")

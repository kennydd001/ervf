# PORT80B-T0-P1 — immutable official layer-0 real-Q5 physical preregistration

Date: 2026-08-13  
Phase: physical candidate, closed until T0-R1 passes independently  
Target revision: `a19358a7659bd1f564300250ee189120c49a562f`

This is the provenance-complete revision of the blocked T0-P document. Its
numerical, physical, resource and timing gates are not relaxed.
...
from T0-R1 and reproduce its independent dequantized-Q5 oracle bit-for-bit?
...
T0-P1 is closed unless every T0-R1 gate passes and a separate CPU verifier
rehashes all raw bytes. Freeze the T0-R1 result, prompt lock, environment lock,
official index/shard, quantizer, bank builder, physical runner, verifier and
this preregistration by SHA-256. T0-R1 preregistration SHA-256 is
`9993828c2eb8048c282f614fb642f3e9a78a16686da0d2ed96e35bfa00d9c801`.
...
Build one new immutable layer-0 bank from official shard 1 after T0-R1:
...
- Primary: the exact 32 T0-R1 held-out rows at positions 8–15 in locked order.
...
payload hashes. Compare every stored array with T0-R1's Q5 oracle under the
...
1. T0-R1 and independent raw-byte verification pass; every lock is current.
2. Bank is exactly 1,040,117,760 bytes; all 513 records rehash/CRC correctly;
   identity and uniqueness gates pass.
3. Natural IDs and normalized weights equal T0-R1 exactly; selected source
...
No T0-P1 outcome automatically opens endurance or a full-depth claim. The next

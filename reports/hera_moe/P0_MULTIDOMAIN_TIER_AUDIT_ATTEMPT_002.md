...
Alle officiële routecalls en logits zijn exact onderschept: `False`. De historische E2GQ-counts zijn niet exact reproduceerbaar door tied BF16-topk (`L1=0`); dit is diagnostiek en geen gate-input.

...
PREREG = R / "PORT80B_D10B_HELDOUT_10000_ENDURANCE_PREREGISTRATION.md"
COMPILE_OUT = R / "port80b_d10b_heldout_10000_endurance_preflight.json"
COMPILE_REPORT = R / "PORT80B_D10B_HELDOUT_10000_ENDURANCE_PREFLIGHT_REPORT_2026-08-13.md"
COMPONENT_OUT = R / "port80b_d10a2r2_gdn36_oracle_repair.json"
ENDURANCE_OUT = R / "port80b_d10b_heldout_10000_endurance.json"
REPORT = R / "PORT80B_D10B_HELDOUT_10000_ENDURANCE_REPORT_2026-08-13.md"
...
def compile_phase() -> None:
    ...
    result = {
        "kind": "port80b_d10b_heldout_10000_endurance_cpu_preflight",
...
def endurance_phase(acknowledgement: str | None) -> None:
    ...
    overall = bool(gates) and all(gates.values())
    result = {
        "kind": "port80b_d10b_heldout_10000_endurance",
        "completed_utc": datetime.now(timezone.utc).isoformat(),
    ...
    REPORT.write_text(
        "# PORT80B-D10B held-out 10,000-step endurance report\n\n"
        f"Verdict: **{result['status']}**.\n\n"
